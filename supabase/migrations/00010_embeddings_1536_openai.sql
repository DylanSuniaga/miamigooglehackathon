-- Migration: Change embedding dimension back to 1536 for OpenAI and create automatic trigger

-- 1. Drop the index and modify column
...
-- 2. Update match_messages function to 1536
