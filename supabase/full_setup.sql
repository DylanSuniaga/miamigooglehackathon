-- ============================================
-- FULL SCHEMA SETUP — paste into Supabase SQL Editor and run
-- ============================================
...
insert into profiles (id, username, display_name, avatar_url) values
  ('00000000-0000-0000-0000-000000000200', 'fabian', 'Fabian', null),
...
insert into channel_members (channel_id, member_type, member_id) values
  ...
  ('00000000-0000-0000-0000-000000000010', 'user', '00000000-0000-0000-0000-000000000201'),
  ('00000000-0000-0000-0000-000000000011', 'user', '00000000-0000-0000-0000-000000000201'),
  ('00000000-0000-0000-0000-000000000012', 'user', '00000000-0000-0000-0000-000000000201'),
  ('00000000-0000-0000-0000-000000000010', 'user', '00000000-0000-0000-0000-000000000202'),
  ('00000000-0000-0000-0000-000000000011', 'user', '00000000-0000-0000-0000-000000000202'),
  ('00000000-0000-0000-0000-000000000012', 'user', '00000000-0000-0000-0000-000000000202'),
  ('00000000-0000-0000-0000-000000000010', 'user', '00000000-0000-0000-0000-000000000203'),
  ('00000000-0000-0000-0000-000000000011', 'user', '00000000-0000-0000-0000-000000000203'),
  ('00000000-0000-0000-0000-000000000012', 'user', '00000000-0000-0000-0000-000000000203');
